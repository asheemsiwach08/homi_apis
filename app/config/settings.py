...
class Settings:
    ...
    BASICHOMELOAN_GUPSHUP_API_KEY=os.getenv("BASICHOMELOAN_GUPSHUP_API_KEY", "")
    BASICHOMELOAN_GUPSHUP_APP_ID=os.getenv("BASICHOMELOAN_GUPSHUP_APP_ID", "")
    BASICHOMELOAN_GUPSHUP_APP_NAME=os.getenv("BASICHOMELOAN_GUPSHUP_APP_NAME", "")
    BASICHOMELOAN__GUPSHUP_SOURCE=os.getenv("BASICHOMELOAN__GUPSHUP_SOURCE", "")

    IRABYBASIC_GUPSHUP_API_KEY=os.getenv("IRABYBASIC_GUPSHUP_API_KEY", "")
    IRABYBASIC_GUPSHUP_APP_ID=os.getenv("IRABYBASIC_GUPSHUP_APP_ID", "")
    IRABYBASIC_GUPSHUP_APP_NAME=os.getenv("IRABYBASIC_GUPSHUP_APP_NAME", "")
    IRABYBASIC_GUPSHUP_SOURCE=os.getenv("IRABYBASIC_GUPSHUP_SOURCE", "")

    BASICTALENTORB_GUPSHUP_API_KEY=os.getenv("BASICTALENTORB_GUPSHUP_API_KEY", "")
    BASICTALENTORB_GUPSHUP_APP_ID=os.getenv("BASICTALENTORB_GUPSHUP_APP_ID", "")
    BASICTALENTORB_GUPSHUP_APP_NAME=os.getenv("BASICTALENTORB_GUPSHUP_APP_NAME", "")
    BASICTALENTORB_GUPSHUP_SOURCE=os.getenv("BASICTALENTORB_GUPSHUP_SOURCE", "")

    HOMFINITY_GUPSHUP_API_KEY=os.getenv("HOMFINITY_GUPSHUP_API_KEY", "")
    HOMFINITY_GUPSHUP_APP_ID=os.getenv("HOMFINITY_GUPSHUP_APP_ID", "")
    HOMFINITY_GUPSHUP_APP_NAME=os.getenv("HOMFINITY_GUPSHUP_APP_NAME", "")
    HOMFINITY_GUPSHUP_SOURCE=os.getenv("HOMFINITY_GUPSHUP_SOURCE", "")

    HOMIAI_GUPSHUP_API_KEY=os.getenv("HOMIAI_GUPSHUP_API_KEY", "")
    HOMIAI_GUPSHUP_APP_ID=os.getenv("HOMIAI_GUPSHUP_APP_ID", "")
    HOMIAI_GUPSHUP_APP_NAME=os.getenv("HOMIAI_GUPSHUP_APP_NAME", "")
    HOMIAI_GUPSHUP_SOURCE=os.getenv("HOMIAI_GUPSHUP_SOURCE", "")
